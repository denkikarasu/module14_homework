// Функция-обертка над XMLHttpRequest
  ...
  // Ошибку с дебаггером повторить не удалось. На скриншоте вижу, что в файле другой код (не тот, что сейчас). Возможно, изменения, которые вы внесли, решили проблему.